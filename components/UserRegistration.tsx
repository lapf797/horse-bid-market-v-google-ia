    ...
    try {
        ...
        if (authData.user) {
            ...
            if (profileError) {
                ...
                // Note: User created but profile failed. Handle appropriately in prod.
            }
      ...
      <div className="max-w-6xl w-full bg-white rounded-2xl shadow-2xl overflow-hidden flex flex-col md:flex-row min-h-[700px]">
        ...
        <div className="hidden md:flex md:w-5/12 bg-equus-navy relative p-12 flex-col justify-between overflow-hidden">
            ...
            <div className="relative z-10 space-y-8">
               {/* Keep static content */}
               <p className="text-white">Junte-se à maior comunidade de elite equestre.</p>
            </div>
        ...
        <div className="w-full md:w-7/12 p-8 md:p-12 flex flex-col relative">
                        ...
                        <div className="space-y-4">
                            <div>
                                ...
                                <input 
                                    ...
                                    value={formData.name}
                                    onChange={handleMask}
                                    className="w-full p-4 border border-gray-200 rounded-lg bg-gray-50 focus:bg-white focus:border-equus-gold focus:ring-1 focus:ring-equus-gold outline-none transition-all"
                        ...
                        <div className="space-y-4">
                            <div>
                                ...
                                <input 
                                    ...
                                    value={formData.cpf}
                                    onChange={handleMask}
                                    className="w-full p-4 border border-gray-200 rounded-lg bg-gray-50 focus:bg-white focus:border-equus-gold focus:ring-1 focus:ring-equus-gold outline-none transition-all font-mono tracking-wider"
                    ...
                    <div className="space-y-6 animate-fade-in">
                        ...
                        <div className="flex gap-4 items-end">
                            ...
                            <button 
                                ...
                                className="h-[58px] px-6 bg-equus-navy text-white rounded-lg font-bold uppercase text-xs tracking-wider hover:bg-gray-800 disabled:opacity-50"
                            >
                                {loading ? 'Buscando...' : 'Buscar CEP'}
                            </button>
                        </div>
                        {/* Address Fields (Street, Number, etc) - Same as previous version */}
                        <div className="grid grid-cols-3 gap-4">
                            ...
                            <div>
                                ...
                                <input 
                                    ...
                                    onChange={handleMask}
                                    className="w-full p-4 border border-gray-200 rounded-lg bg-gray-50 focus:bg-white focus:border-equus-gold outline-none"
                                />
                            </div>
                        </div>
                    </div>
                        ...
                        <div className="space-y-4">
                             ...
                             <div>
                                ...
                                <input 
                                    ...
                                    onChange={handleMask}
                                    className={`w-full p-4 border rounded-lg bg-gray-50 focus:bg-white outline-none transition-all ${
                                        formData.confirmPassword && formData.password !== formData.confirmPassword 
                                        ? 'border-red-300 ring-1 ring-red-300' 
                                        : 'border-gray-200 focus:border-equus-gold focus:ring-1 focus:ring-equus-gold'
                                    }`}
                                />
                            </div>
                        </div>
                        ...
                        <div className="pt-4 border-t border-gray-100">
                             <label className="flex items-start gap-3 p-4 border border-gray-200 rounded-lg cursor-pointer hover:bg-gray-50 transition-colors">
                                <input 
                                    ...
                                    className="mt-1 w-5 h-5 accent-equus-navy" 
                                />
                                <span className="text-sm text-gray-600">
                                    Li e concordo com os <a href="#" className="text-equus-navy font-bold underline">Termos de Uso</a> e <a href="#" className="text-equus-navy font-bold underline">Política de Privacidade</a> do Horse Bid Market.
                                </span>
                             </label>
                        </div>
                    </div>
            ...
            <div className="mt-8 pt-6 border-t border-gray-100 flex justify-between items-center">
                {step === 1 ? (
                    <button onClick={onCancel} className="text-gray-400 hover:text-gray-600 font-bold uppercase text-xs tracking-wider">
                        Cancelar
                    </button>
                ) : (
                    <button onClick={() => setStep(step - 1)} className="text-gray-500 hover:text-equus-navy font-bold uppercase text-xs tracking-wider">
                        Voltar
                    </button>
                )}
                ...
                {step < 4 ? (
                     <button 
                        ...
                        className="bg-equus-navy text-white px-8 py-4 rounded shadow-lg hover:shadow-xl hover:bg-gray-800 transition-all font-bold uppercase text-xs tracking-widest"
                     >
                        Próximo Passo
                     </button>
                ) : (
                     <button 
                        ...
                        className="bg-equus-gold text-equus-navy px-8 py-4 rounded shadow-lg hover:shadow-xl hover:bg-white transition-all font-bold uppercase text-xs tracking-widest disabled:opacity-50 disabled:cursor-not-allowed"
                     >
